	...
	<div class="tm-tpl tpl-white-hn small-item" style-name="tpl-white-hn">
		...
		<div class="tpl-left-sidebar">
			<ul>
				...
				<li class="nav-item">
					<a href="index.html" class="a-item"><i class="fa fa-home nav-icon"></i><span>关于我们</span></a>
				</li>
			</ul>
		</div>
		<!--右侧内容-->
				...
				<div class="tpl-content">
					<div class="tpl-pannel">
						<div class="tpl-h-title">
							<a>请上传假条图片</a>
						        <form action="leave后端1.php?date=<?php echo $values->date;?>" method="post" enctype="multipart/form-data">
